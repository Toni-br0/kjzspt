...
public class SysDictDataController extends BaseController {
     ...
     */
    @PostMapping("save")
    @Log(title = "新增字典数据", describe = "新增字典数据", type = BusinessType.ADD)
    @PreAuthorize("hasPermission('/system/dictData/add','sys:dictData:add')")
     ...
     */
    @PutMapping("update")
    @Log(title = "修改字典数据", describe = "修改字典数据", type = BusinessType.EDIT)
    @PreAuthorize("hasPermission('/system/dictData/edit','sys:dictData:edit')")
    ...
    @Log(title = "删除字典数据", describe = "删除字典数据", type = BusinessType.REMOVE)
