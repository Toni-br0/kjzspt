...
public class SysRoleController extends BaseController {
    ...
    @Log(title = "新增角色", describe = "新增角色", type = BusinessType.ADD)
    @PreAuthorize("hasPermission('/system/role/add','sys:role:add')")
    ...
    @Log(title = "修改角色", describe = "修改角色", type = BusinessType.EDIT)
    @PreAuthorize("hasPermission('/system/role/edit','sys:role:edit')")
    ...
    @Log(title = "删除角色", describe = "删除角色", type = BusinessType.REMOVE)
