...
public class SysPowerController extends BaseController {
     ...
     */
    @PostMapping("save")
    @Log(title = "新增菜单", describe = "新增菜单", type = BusinessType.ADD)
    @PreAuthorize("hasPermission('/system/power/add','sys:power:add')")
     ...
     */
    @PutMapping("update")
    @Log(title = "修改菜单", describe = "修改菜单", type = BusinessType.EDIT)
    @PreAuthorize("hasPermission('/system/power/edit','sys:power:edit')")
    ...
    @Log(title = "删除菜单", describe = "删除菜单", type = BusinessType.EDIT)
