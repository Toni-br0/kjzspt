...
public class SysDictController extends BaseController {
     ...
     */
    @PostMapping("save")
    @Log(title = "新增字典类型", describe = "新增字典类型", type = BusinessType.ADD)
    @PreAuthorize("hasPermission('/system/dictType/add','sys:dictType:add')")
     ...
     */
    @PutMapping("update")
    @Log(title = "修改字典类型", describe = "修改字典类型", type = BusinessType.EDIT)
    @PreAuthorize("hasPermission('/system/dictType/edit','sys:dictType:edit')")
    ...
    @Log(title = "删除字典类型", describe = "删除字典类型", type = BusinessType.REMOVE)
